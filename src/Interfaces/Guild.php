...
interface Guild {
	 ...
	 *
	 * @param array $options ['guild.id' => 'snowflake', 'user.id' => 'snowflake', 'nick' => 'string', 'roles' => 'array', 'mute' => 'boolean', 'deaf' => 'boolean', 'channel_id' => 'snowflake', 'communication_disabled_until' => 'ISO8601 timestamp']
	 * @return array
	 */
